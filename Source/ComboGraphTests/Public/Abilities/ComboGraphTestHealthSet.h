...
#include "ComboGraphTestHealthSet.generated.h"
...
UCLASS()
class COMBOGRAPHTESTS_API UComboGraphTestHealthSet : public UAttributeSet
{
	GENERATED_BODY()
...
public:
    ...
    ATTRIBUTE_ACCESSORS(UComboGraphTestHealthSet, Health)
	...
	ATTRIBUTE_ACCESSORS(UComboGraphTestHealthSet, MaxHealth)
	...
	ATTRIBUTE_ACCESSORS(UComboGraphTestHealthSet, Damage)
